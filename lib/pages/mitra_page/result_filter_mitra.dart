...
class _ResultFilterMitraState extends State<ResultFilterMitra> {
  ...
  Future<void> _loadFilteredEvents(Map<String, dynamic> filters) async {
    try {
      ...
      String? selectedFundRange = filters['fundRange'];  // langsung ambil String? bukan Map
      ...
      String? fundRange = selectedFundRange != null && selectedFundRange.isNotEmpty
          ? fundRangeValues[selectedFundRange]
          : null;
