...
class SearchResultPageOrg extends StatefulWidget {
  final List<Event> allEvents;
  final String searchQuery;

  const SearchResultPageOrg({
    Key? key,
  ...
  @override
  _SearchResultPageOrgState createState() => _SearchResultPageOrgState();
}

class _SearchResultPageOrgState extends State<SearchResultPageOrg> {
